...
class LeftPane(ttk.Frame):
    def __init__(self, master: ttk.Frame):
        ...
        self.battery_soc_percentage_flood_gauge.grid(column=0, row=1,
                                                     sticky="nsew", padx=10)
        self.course_frame: ttk.Frame = self.title_widget_frame()
        self.title_course_label: ttk.Label = ttk.Label(self.course_frame,
                                                       text="Indicador de Dirección", font=("Digital-7", 17))
        self.course_indicator_variable: ttk.Variable = ttk.Variable(value="0")
        self.course_label: ttk.Label = ttk.Label(self.course_frame,
                                                 textvariable=self.course_indicator_variable,
                                                 font=("Digital-7", 22)
                                                 )
        self.title_course_label.grid(column=0, row=0)
    ...
    def place_widgets(self) -> None:
        ...
        self.course_frame.grid(row=2, column=0, sticky="nesw")
...
class CenterPane(ttk.Frame):
    def __init__(self, master):
        ...
        self.speed_indicator = ttk.Meter(self.speed_frame,
                                         ...
                                         arcrange=180,
                                         arcoffset=180,
                                         bootstyle="info", textfont="-size 26 -weight bold", subtextfont="-size 14",
                                         subtextstyle="light")
...
class RightPane(ttk.Frame):
    def __init__(self, master):
        ...
        self.title_load_power_label = ttk.Label(self.load_power_frame,
                                                text="Descarga Motor", font=("Digital-7", 17))
