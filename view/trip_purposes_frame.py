...
class TripPurposes(ttk.Frame):
    def __init__(self, master: ttk.Window, label_font_size: tuple, trip_purposes: list):
        ...
        self.trip_purpose_var: ttk.StringVar = ttk.StringVar(value=None)
        self.buttons = {}
    ...
    def _build_title_frame(self) -> None:
        ...
        ttk.Label(
            title_frame,
            text="Seleccionar Motivo de Viaje",
    ...
    def _build_buttons_frame(self) -> None:
        ...
        n_rows = -(-len(self.trip_purposes) // COLS)  # ceiling division
        ...
        for idx, opt in enumerate(self.trip_purposes):
            row = idx // COLS
            col = idx % COLS
